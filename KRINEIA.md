...
This is the repo-local KRINEIA manifest for `hummbl-dev/cli`.
...
This repository is an archived fork of `httpie/cli`. No KRINEIA chain is bootstrapped. If this fork is ever un-archived and brought into active development, it must:
